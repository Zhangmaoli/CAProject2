...
*/
    ...
    private JLabel labelTop,labelLeft,rightLabel,bottomLabel,fileLabel,fileAddrBtn,stepLabel2, stepLabel1,  csLabel, bsLabel, wayLabel, replaceLabel, prefetchLabel, writeLabel, allocLabel;
...
*/
    private class Instruction {
        ...
        private String HexAddr2BinAddr() {//十六进制转换为二进制
...
*/
    ...
    private final int INSTRUCTION_MAX_SIZE = 10000000;
    private int isize;//指令的总条数
    private int ip;//当前指令
...
*/
    ...
    */
        ...
        public Cache(int csize, int bsize) {
            ...
            groupFIFOTime = new long[groupNum];//为了FIFO使用
        }
...
*/
    ...
    */
    ...
    private void draw() {
      ...
      //*****************************顶部面板绘制*****************************************//
        labelTop = new JLabel("Cache Simulator by PB14011007_张冒莉");
        labelTop.setAlignmentX(CENTER_ALIGNMENT);
        JLabel promptLabel = new JLabel("  (友情提醒： 请先修改左侧设置，再加载流文件运行！)");
        promptLabel.setForeground(Color.pink);
        panelTop.add(labelTop);
        panelTop.add(promptLabel);
 
      //*****************************左侧面板绘制*****************************************//
        labelLeft = new JLabel("Cache 参数设置");
        labelLeft.setPreferredSize(new Dimension(280, 40));
        labelLeft.setForeground(Color.green);
      ...
      //cache 大小设置
        ...
        icsLabel.setPreferredSize(new Dimension(80, 20));
 
        dcsLabel = new JLabel("数据Cache");
        dcsLabel.setPreferredSize(new Dimension(80, 20));
 
        JLabel emptyLabel = new JLabel("");
        emptyLabel.setPreferredSize(new Dimension(100, 20));
 
        icsBox = new JComboBox<String>(scachesize);
        icsBox.setPreferredSize(new Dimension(90, 20));
        ...
        dcsBox.setPreferredSize(new Dimension(90, 20));
        ...
        fileLabel.setPreferredSize(new Dimension(120, 26));
        fileAddrBtn = new JLabel();
        fileAddrBtn.setPreferredSize(new Dimension(210,26));
        ...
        rightLabel.setPreferredSize(new Dimension(480, 40));
        ...
        for (int i = 0; i < 4; i++) {
            ...
            if (i == 0) {
                ...
                label.setPreferredSize(new Dimension(480, 40));
        ...
        */
        ...
        accessTypeDataLabel.setPreferredSize(new Dimension(200, 40));
        addressTagLabel.setPreferredSize(new Dimension(80, 40));
        addressDataLabel.setPreferredSize(new Dimension(80, 40));
        ...
        tagTagLabel.setPreferredSize(new Dimension(80, 40));
        tagDataLabel.setPreferredSize(new Dimension(60, 40));
        indexTagLabel.setPreferredSize(new Dimension(60, 40));
        indexDataLabel.setPreferredSize(new Dimension(70, 40));
        inblockAddressTagLabel.setPreferredSize(new Dimension(80, 40));
        inblockAddressDataLabel.setPreferredSize(new Dimension(80, 40));
        ...
        bottomLabel.setPreferredSize(new Dimension(780, 30));
